            ...
            <div class="p-6 bg-white border-b border-gray-200 font-medium leading-tight">
                <div class="flex-grow flex flex-row flex-nowrap justify-items-center">
                    ...
                    <div class="flex-grow">
                        ...
                        <div class="mb-1">
                            <a href="{{ route('books.editing', ['id'=>$book->id]) }}"
                        ...
                        <p class="text-xs text-gray-500">
                            <span class="select-none pointer-events-none">{{ __('general.author') }}: </span> {{ $book->authorName }}
                        </p>

                        <p class="text-xs text-gray-500">
                            <span class="select-none pointer-events-none">{{ __('general.id') }}: </span> {{ $book->id }}
                        </p>
